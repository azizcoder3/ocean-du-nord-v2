        ...
        <div className="bg-gray-50 p-4 rounded-xl border border-gray-200">
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              className="w-full p-3 bg-white border rounded-xl outline-none focus:border-primary min-h-[100px]"
            />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div>
              ...
              <textarea
                ...
                className="w-full p-3 bg-white border rounded-xl outline-none focus:border-primary min-h-[80px]"
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">
...
//     try {
//       // 1. Générer un nom unique : timestamp_nomdufichier
//       const fileExt = file.name.split(".").pop();
//       const fileName = `${Date.now()}.${fileExt}`;
//       const filePath = `routes/${fileName}`;

//       // 2. Upload vers le bucket 'odn-media'
//       const { error: uploadError } = await supabase.storage
//         .from("odn-media")
//         .upload(filePath, file);
...
//       // NOTE: On n'utilise plus formData.get("image") ici, mais le state imageUrl
...
//       // Utilisation de l'URL stockée dans le state (ou undefined si vide)
//       const image = imageUrl || undefined;
...
//           {imageUrl ? (
//             // Aperçu de l'image si elle est chargée
//             <div className="relative w-full h-48 rounded-xl overflow-hidden border border-gray-200 group">
//               <Image
//                 src={imageUrl}
//                 alt="Aperçu"
...
//         {/* Le champ image input text est supprimé car remplacé par l'uploader */}
...
//                 Ville d&apos;arrivée
//               </label>
//               {/* This space is intentionally left for symmetry */}
//             </div>
//           </div>
...
//         <button
//           type="submit"
//           disabled={isLoading || isUploading} // Désactivé si chargement ou upload en cours
//           className="w-full bg-primary text-white p-4 rounded-xl font-bold shadow-lg shadow-primary/20 disabled:opacity-50 disabled:cursor-not-allowed hover:bg-primary/90 transition-all"
//         >
//           {isLoading ? "Création en cours..." : "Créer la destination"}
//         </button>
