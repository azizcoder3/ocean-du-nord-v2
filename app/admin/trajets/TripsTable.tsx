// app/admin/trajets/TripsTable.tsx
"use client";
              ...
              >
                ...
                <td className="px-6 py-4">
                  <select
                    value={trip.status}
                    onChange={(e) =>
                      handleStatusChange(trip.id, e.target.value as TripStatus)
                    }
                    disabled={isChangingStatus[trip.id]}
                    className={`px-2 py-1 rounded text-[10px] font-bold uppercase border cursor-pointer outline-none disabled:opacity-50 disabled:cursor-not-allowed ${getStatusStyle(
                      trip.status
                    )}`}
                  >
                  ...
                  <div className="flex justify-end gap-2">
                    <button
                      ...
                      title={
                        canModifyTrip(trip)
                          ? "Modifier le voyage"
                          : "Modification impossible (voyage en cours ou terminé)"
                      }
                    >
