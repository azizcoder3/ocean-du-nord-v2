    ...
    async function fetchPopular() {
      try {
        ...
        if (Array.isArray(data)) {
          // MODIFICATION 1 : On ne prend que les 6 premières (pour faire 2 rangées de 3)
  ...
  return (
    <section className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* MODIFICATION 2 : lg:grid-cols-3 au lieu de lg:grid-cols-4 */}
...
// //components/home/PopularRoutes.tsx avec 6 rangés
// "use client";
